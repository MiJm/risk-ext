...
//添加操作待用
func (this *StayView) Post(ctx iris.Context) (statuCode int, data M) {
	return
}

//更新操作待用
func (this *StayView) Put(ctx iris.Context) (statuCode int, data M) {
	return
}

//删除操作待用
func (this *StayView) Delete(ctx iris.Context) (statuCode int, data M) {
	return
}
