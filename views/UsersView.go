...
//小程序登录
func (this *UsersView) Get(ctx iris.Context) (statuCode int, result interface{}) {
	data := make(app.M)
	defer func() {
		result = data
	}()
...
func (this *UsersView) Post(ctx iris.Context) (statuCode int, result interface{}) {
	data := make(app.M)
	defer func() {
		result = data
	}()
...
func (this *UsersView) Put(ctx iris.Context) (statuCode int, result interface{}) {
	data := make(app.M)
	defer func() {
		result = data
	}()
...
//删除操作待用
func (this *UsersView) Delete(ctx iris.Context) (statuCode int, data interface{}) {
	return
}
