...
//获取详情或列表待用
func (this *AmountView) Get(ctx iris.Context) (statuCode int, data M) {
	return
}

//添加操作待用
func (this *AmountView) Post(ctx iris.Context) (statuCode int, data M) {
	return
}

//删除操作待用
func (this *AmountView) Delete(ctx iris.Context) (statuCode int, data M) {
	return
}
